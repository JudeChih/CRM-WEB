...
<table style="width:600px;margin: 0 auto;font-family:微軟正黑體; font-size:14px;">
    ...
    <tbody>
        ...
        <tr>
            <td style="padding:5px 0 5px 40px;">連絡人：{{ $casedata->contact_name }}</td>
        </tr>
        <tr>
            <td style="padding:5px 0 5px 40px;">電子郵件：{{ $casedata->contact_mail }}</td>
        </tr>
        <tr>
            <td style="padding:5px 0 5px 40px;">連絡電話：{{ $casedata->contact_phone }}</td>
        </tr>
        <tr>
        ...
        @else
            <td style="padding:5px 0 5px 40px;">上傳的檔案：<a href="{{ $downloadURL.$casedata->support_filename }}" >連結</a></td>
        @endif
        <tr>
