...
<div class="survey_form_style col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
    <div class="survey_title col-md-12 col-sm-12 col-xs-12">
        <a href="http://www.sunwai.com">
            <img class="img-responsive center-block" src="\images\sunwai01.png" alt="sunwai" />
        </a>
    </div>
    <div class="survey_title col-md-12 col-sm-12 col-xs-12">
    ...
    <form role="form" name="supportSurveyForm" action="/support/closesatisfaction" class="survey_form col-md-12 col-sm-12 col-xs-12 p_l_r_dis" method="POST" enctype="multipart/form-data">
        {!! csrf_field() !!}
        ...
        <div class="form-group col-md-12 col-sm-12 col-xs-12">
            <label for="score{{ sprintf("%02d",$ss->ss_sort) }}" class="control-label problem_subject p_l_r_dis col-md-12 col-sm-12 col-xs-12">
                ...
                <span class="col-md-7 col-sm-7 col-xs-7 text-left">{{ $ss->ss_description }}</span>
