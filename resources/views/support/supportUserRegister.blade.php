...
<div class="j_form_style col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
    ...
    <form role="form" name="register" action="/support/support" class="j_form col-md-12 col-sm-12 col-xs-12" method="POST">
        {!! csrf_field() !!}
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 btn_p_r_b">
            <button type="submit" class="btn pull-right">註冊</button>
        </div>
    </form>
</div>
