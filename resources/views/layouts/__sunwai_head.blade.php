...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav toto">
                        ...
                        <li><a href="/holiday/holiday">休假日設定</a></li>
                        <!--                        <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li><a href="/support/closesatisfaction/qq">滿意度調查</a></li>
                                                        <li><a href="/applytest/applyservice">申請試用</a></li>
                                                    </ul>
                                                </li>-->
                        <!--                        
                        <li class="dropdown">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/logout" style="text-align: center;">登出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            ...
            POST：{{  json_encode($_POST) }}<br><br>
            GET：{{  json_encode($_GET) }}<br><br>
            TOKEN：{{  App\Services\AuthService::token() }}<br>
            使用者代碼：{{  App\Services\AuthService::userID() }}<br>
            使用者名稱：{{  App\Services\AuthService::userName() }}<br>
            使用者等級：{{  App\Services\AuthService::authLevel() }}<br>
            POST：{{  json_encode($_POST) }}<br><br>
