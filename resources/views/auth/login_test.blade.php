            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('password' ,'qqqq',['class'=>'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {{ Form::label('使用者名稱','',['class'=>'col-md-4 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::text('username' ,'eeee',['class'=>'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {{ Form::label('使用者密碼','',['class'=>'col-md-4 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::text('password' ,'eeee',['class'=>'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {{ Form::label('使用者名稱','',['class'=>'col-md-4 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::text('username' ,'mmmm',['class'=>'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {{ Form::label('使用者密碼','',['class'=>'col-md-4 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::text('password' ,'mmmm',['class'=>'form-control']) }}
                        </div>
                    </div>
