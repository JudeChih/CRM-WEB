...
@section('content')
<script type="text/javascript" src="/js/case_table_style.js"></script>
...
<div class="j_holiday col-md-6 col-sm-8 col-xs-10 col-md-offset-3 col-sm-offset-2 col-xs-offset-1 panel panel-info p_l_r_dis">
  ...
  <div class="panel-body">
		<form role="form" method="POST" enctype="multipart/form-data" action="/supportcase/case_table" class="col-md-12 col-sm-12 col-xs-12 p_l_r_dis">
			{!! csrf_field() !!}
			<div class="btn_left col-md-1 col-sm-1 col-xs-1">
			...
			<div class="btn_right col-md-1 col-sm-1 col-xs-1">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 clearfix p_l_r_dis">
			...
			<form role="form" name="holiday_form" method="POST" enctype="multipart/form-data" action="/supportcase/case_table_save">
				{!! csrf_field() !!}
