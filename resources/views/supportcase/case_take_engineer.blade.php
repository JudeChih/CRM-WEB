...
<div class="case_setting_content col-md-10 col-sm-12 col-xs-12 col-md-offset-1 panel panel-info p_l_r_dis">
    ...
    <div class="panel-body">
        <div class="col-md-12 col-sm-12 col-xs-12 case_setting_search">
            {{ Form::open(['action'=>'ViewControllers\SupportCaseQueryController@detailActionTakeEngineer','class'=>'navbar-form navbar-left']) }}
            ...
            {{ Form::open(['action' => array('ViewControllers\SupportCaseQueryController@detailActionTakeEngineer'),'class'=>'return_case_detail']) }}
            {{ Form::hidden('support_id', $support_id) }}
            {{ Form::close() }}
        ...
        {{ Form::open(['action' => array('ViewControllers\SupportCaseQueryController@detailActionTakeEngineer')]) }}
